...
- [x] 0.1 Crear y confirmar feature/mejorar-seo-certificados desde main.

## 1. SEO y certificados

- [x] 1.1 Verificar originales y respaldo desde CV ampliado y diplomas; registrar evidencia pública.
- [x] 1.2 Actualizar seis enlaces Udemy y nombres accesibles.
- [x] 1.3 Incorporar metadatos, microdatos, robots.txt y sitemap.xml, con SITE_FILES actualizado.

- [x] 1.4 Integrar registro y PDF original de SCRUMstudy verificados; optimizar tarjetas, pies de acciones y controles táctiles. Fuente: enlaces aportados por el titular el 18/09/2026.

- [x] 1.5 Renovar diseño general según frontend-plan.md, preservando textos y enlaces.
